<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated fadeIn delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-1">
          <a href="<?=url("tbl_master_golongan/add")?>" id="add" class="btn btn-sm btn-success btn-icon-text"><i class="fa fa-file btn-icon-prepend"></i> <?=cclang("add_new")?></a>
          ...
          <a href="<?=url("tbl_master_golongan/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i> Filter</a>
        </div>
...
//datatables
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "<?=url("tbl_master_golongan/json")?>",
          "type": "POST",
          "data":function(data){
						data.golongan = $("#golongan").val();
